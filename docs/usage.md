...
8. 「ZIPでダウンロード」ボタンを押すと、チェックが入っている(採用中の)フレームをまとめてZIPでダウンロードできます。
...
結果一覧ヘッダの「GIFでダウンロード」ボタン(ZIPボタンの右隣)を押すと、採用中のフレームをタイムスタンプ昇順に1本のアニメーションGIFとしてまとめて書き出せます。生成中はボタンが無効化され、「生成中…(n/総数)」の形式で進捗が表示されます。
